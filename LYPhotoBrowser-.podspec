#
#  Be sure to run `pod spec lint LYPhotoBrowser.podspec' to ensure this is a
...
a photo browser tool , use this you can scroll it infinitly
  ...
  s.source       = { :git => "https://github.com/install-b/LYPhotoBrowser-.git", :tag => "0.0.6" }
